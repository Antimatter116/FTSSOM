									...
									<section class="container">
										...
										<script>
										    window.onload = function() {
										        var thegamelink = "Unity/Multi/index.php";
										        var ref = document.referrer;
										        var theurl = https:"Unity/Multi/index.php";
										        ref = ref.substring(ref.indexOf("://") + 3);
										        ref = ref.split("/")[0];
										        if(ref == "my-ga.me"){
										        theurl = "true"
										        } else {
										            theurl = "https://iskama.org/Unity/Multi/index.php"
										        } 
										        document.getElementById("embededGame").src = thegamelink+"/"+theurl+"?url="+window.location.href;
										    }
										</script>
										<div style="position: relative; height: 0; overflow: hidden; padding-bottom: 70.25%;"><iframe id="embededGame" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="Unity/Multi/index.php" frameborder="0" scrolling="no" seamless="seamless">Browser not compatible.</iframe></div>
										&nbsp;
						</div>
									</section>
							</div>
