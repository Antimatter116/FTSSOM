			...
			<!-- Header -->
				<header id="header">
					<div class="logo container">
						<div>
							<h1><a href="gamespage.php" id="logo">Human</a></h1>
							<p>Body</p>
						</div>
					</div>
				</header>
			<!-- Nav -->
				<nav id="nav">
					<ul>
						...
						<li class="current"><a href="gcnav.php">Games</a></li>
								...
								<!-- Features -->
									<section class="container">
										...
										<script>
											...
											var thegamelink = "https://schools.tinybop.com/model-embed.php?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlcyI6W1sxLFsiU1RVREVOVCJdXV0sImV4cCI6MTYzMTc1MDQwMCwic3hwIjowLCJ1c2VyX2lkIjoxM30.H_qBSbuHPBWFWZjDK6zgfWtNzyiNmJyJrugv4fj6qM8&amp;target=funbrain";
										...
										<div style="position: relative;height: 0;overflow: hidden;padding-bottom: 70.25%;">
											<iframe id="embededGame" src=https://schools.tinybop.com/model-embed.php?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlcyI6W1sxLFsiU1RVREVOVCJdXV0sImV4cCI6MTYzMTc1MDQwMCwic3hwIjowLCJ1c2VyX2lkIjoxM30.H_qBSbuHPBWFWZjDK6zgfWtNzyiNmJyJrugv4fj6qM8&amp;target=funbrain" scrolling="no" seamless="seamless" frameBorder="0" style="position: absolute;top:0;left: 0;width: 100%;height: 100%;">Browser not compatible.</iframe>
						</div>
									</section>
							</div>
						</div>
